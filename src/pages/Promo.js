    ...
    <div className="w-full scrollbar-hide">
      ...
      {content.map((val, index) => (
        <div key={index} className="w-full container mx-auto ">
          <div className="flex flex-col items-center justify-center space-x-4 my-20 sm:flex-row sm:items-start">
            <div
              data-aos="fade-up"
            ...
            <div className="sm:w-[330px] w-full p-[10px] h-full flex flex-col text-slate-700 space-y-2">
              <div className="uppercase font-poppins  text-left space-y-2">
                ...
                <p className="font-extrabold text-[12px]">{val.desc[1].text}</p>
              </div>
            ...
            <div className="w-full mt-8 px-4 flex flex-col items-center justify-center space-y-2">
              <div className="font-poppins font-semibold text-slate-700 text-[18px]">
                <h2 className="">Hitung Cicilan Anda Disini</h2>
              </div>
              <div className="w-full flex flex-col sm:flex-row space-y-2 sm:space-x-2">
                <input
                  className="transition ease-linear duration-300 font-poppins text-sm rounded-[4px] border-2 text-black p-[4px] border-slate-700/50 focus:border-slate-700"
              ...
              <div className="w-full flex flex-col items-center justify-center sm:flex-row space-y-2 sm:space-x-2 ">
                <select
              ...
              <div className="w-full flex flex-col  items-center justify-center space-y-2 sm:flex-row sm:space-x-2 ">
                <select
                  className="rounded-[4px] p-[4px] w-full text-black border-2 border-slate-700/50 uppercase focus:border-slate-700"
                  placeholder="Stargazer"
                >
